...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        KC_TAB,  KC_QUOT,  KC_COMMA, KC_DOT,  KC_P,    KC_Y,    KC_F,     KC_G,    KC_C,    KC_R,    KC_L,     KC_LBRC,  KC_RBRC,  KC_BSLS,          KC_DEL,
        KC_CAPS, KC_A,     KC_O,     KC_E,    KC_U,    LSFT_T(KC_I),             RSFT_T(KC_D),    KC_H,    KC_T,    KC_N,     KC_S,  KC_MINS,  KC_ENT,           KC_HOME,
        KC_LSFT,           KC_SCLN,  KC_Q,    LCMD_T(KC_J),    LCTL_T(KC_K),    LOPT_T(KC_X),     QK_LEAD,    ROPT_T(KC_B),    RCTL_T(KC_M), RCMD_T(KC_W),  KC_V,   KC_Z,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LOPT,  KC_LCMD,           TT(MAC_FN2),           MO(MAC_FN1),  TT(MAC_FN2) , KC_SPC,                    KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_69_ansi(
        ...
        KC_LCTL, KC_LWIN,  KC_LALT,           KC_SPC,           MO(WIN_FN1), MO(MAC_FN2),         KC_SPC,            KC_RALT,            KC_LEFT, KC_DOWN, KC_RGHT),

    [MAC_FN1] = LAYOUT_69_ansi(
        KC_GRV,  KC_BRID,  KC_BRIU,  KC_NO,   KC_NO,   RGB_VAD, RGB_VAI,              KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,                   KC_MUTE,
        ...
        _______,      _______, KC_PGUP, _______, KC_PGDN, KC_ACL1,                    KC_ACL2, _______, KC_1,  KC_2,  KC_3,  _______, _______,             P2P4G,
        _______,  _______,     _______,           _______,          _______,          _______,          KC_0,           _______,            BT_HST1, BT_HST2, BT_HST3),
    ...
    [MAC_FN2] = LAYOUT_69_ansi(
        ...
        _______, _______,  KC_BTN3,  KC_BTN2, KC_BTN1, KC_ACL0,                KC_ACL1, KC_MS_L, KC_MS_D,  KC_MS_R, KC_ACL1,  KC_ACL0,  _______,             _______,
        _______, RGB_RMOD, RGB_VAD,  RGB_HUD, RGB_SAD, RGB_SPD,        KC_ACL2, _______, KC_WH_U,  KC_WH_D,  _______, _______,  _______,          _______,
        _______, _______,           _______,  KC_BTN2, _______,        _______,          KC_BTN1,            _______,           _______, _______,  _______),
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [MAC_FN1]   = {ENCODER_CCW_CW(KC_MS_L, KC_MS_R)},
    [WIN_FN1]   = {ENCODER_CCW_CW(RGB_VAD, RGB_VAI)},
    [MAC_FN2]      = {ENCODER_CCW_CW(KC_MS_D, KC_MS_U)}
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_69_ansi(
        ...
        KC_CAPS, KC_A,	   KC_S,	 KC_D,	  KC_F,    KC_G,              KC_H,    KC_J,	KC_K,	 KC_L,	   KC_SCLN,  KC_QUOT,  KC_ENT,           KC_HOME,
        KC_LSFT,           KC_Z,	 KC_X,	  KC_C,    KC_V,	KC_B,	  KC_B,    KC_N,	KC_M,	 KC_COMM,  KC_DOT,	 KC_SLSH,  KC_RSFT, KC_UP,
        KC_LCTL, KC_LOPTN, KC_LCMMD,          KC_SPC,           MO(MAC_FN1), MO(MAC_FN2),       KC_SPC,            KC_RCMMD,           KC_LEFT, KC_DOWN, KC_RGHT),
